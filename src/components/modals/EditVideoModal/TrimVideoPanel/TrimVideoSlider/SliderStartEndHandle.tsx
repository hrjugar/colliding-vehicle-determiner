...
const SliderStartEndHandle: React.FC<SliderStartEndHandleProps> = ({ handle, getHandleProps }) => {
  ...
  return (
    <div 
      className={`absolute z-[2] border-none cursor-pointer transform  -translate-x-1/2 flex flex-col items-center`}
      style={{
        left: `${handle.percent}%`,
      }}
    ...
    >
      ...
      <div className='w-4 h-4 bg-white rounded-full border-2 border-color-primary'/>
